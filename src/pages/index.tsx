...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`ANAS App`}</title>

        <meta
          name="description"
          content="Experience shopping like never before with ANAS App, your ultimate online destination for sanitary ware of exceptional quality."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1679908731995-4ee6f1ceedbc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxzYW5pdGFyeSUyQndhcmV8ZW58MHx8fHwxNjk4NjQ2Mjc4fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@fonsheijnsbroek_amsterdam_photos?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Fons Heijnsbroek`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience shopping like never before with ANAS App, your ultimate online destination for sanitary ware of exceptional quality.`}
            </Text>
            <Box
